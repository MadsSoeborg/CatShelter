...
object CatRepository {
    ...
    private val cats = listOf(
        ...
        Cat("c7", "Snow", "Sad", "1 year", "Male", 4.3, "Meet Snow! A sweet, curious and cuddly cat who is looking for a lovely home. He will live as an indoor and outdoor cat.", R.drawable.snow)
    )
